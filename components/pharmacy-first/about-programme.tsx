        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {pfpBenefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="interactive-hover-surface--compact flex flex-col items-center text-center p-4 rounded-lg bg-card shadow-sm dark:shadow-md/30 border border-border transition-all duration-300 hover:shadow-md hover:border-primary/20 z-10"
              >
                <div className="pfp-benefit-icon-wrap mb-4 flex size-12 items-center justify-center rounded-full bg-accent">
                  <Icon className="pfp-benefit-icon size-6 text-ring" />
                </div>
